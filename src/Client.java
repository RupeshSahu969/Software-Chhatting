...
public class Client extends JFrame implements ActionListener{
	...
	Client(){
		...
		//ImageIcon i1= new ImageIcon(ClassLoader.getSystemResource("/Chatting Application/src/icon/vvv.png.jpg"));
		//Image i2=i1.getImage().getScaledInstance(30, 30, Image_SCALE_DEFAULT);
		...
		public void mouseClicked(MouseEvent ae) {
			System.exit(0);
				...
				//ImageIcon i4= new ImageIcon(ClassLoader.getSystemResource("/Chatting Application/icon/rrr.png.jpg"));
				//Image i5=i4.getImage().getScaledInstance(60, 60, Image_SCALE_DEFAULT);
		...
		//ImageIcon i7= new ImageIcon(ClassLoader.getSystemResource("/Chatting Application/icon/rrr.png.jpg"));
